...
int _tmain(int argc, _TCHAR* argv[])
	...
	GLFWwindow* window = glfwCreateWindow(640, 640, "First GLSL Triangle", NULL, NULL);
	...
	gl::exts::LoadTest didLoad = gl::sys::LoadFunctions(); if (!didLoad) {
	//Load failed
...
//gl::BufferData(gl::ARRAY_BUFFER, 9 * sizeof(float), points2, gl::STATIC_DRAW);
